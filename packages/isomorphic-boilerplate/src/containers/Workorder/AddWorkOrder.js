...
export default function (props) {
  ...
  const [dtmDateCreated, setDtmDateCreated] = React.useState(null);
  ...
  const onSave = () => {
    ...
    console.log("user_id", intRequestedByUserID);
  ...
  const onSuggestedDateChange = (value, dateString) => {
                  ...
                  <Col md={8} sm={8} xs={12} style={colStyle}>
                    ...
                    /> */}
                        <DatePicker
                          ...
                          onChange={onSuggestedDateChange}
                          style={{ width: "70%" }}
                        />
                      </Fieldset>
                    </Form>
