...
export default function (props) {
  ...
  React.useEffect(() => {
    if (Object.keys(workorder).length !== 0) {
      ...
      setMaintanaceTypeId(workorder.workorder.intMaintenanceTypeID);
      ...
      setStrAssets(workorder.workorder.strAssets);
      setProjectTitle(workorder.workorder.projectTitle);
      setDtmSuggestedCompletionDate(
        workorder.workorder.dtmSuggestedCompletionDate
      );
      setDtmDateCreated(workorder.workorder.dtmDateCreated);

      setAssetName(workorder.workorder.strAssets);
      setStrAssetIds(workorder.workorder.strAssetIds);
  ...
  const onChangeCreatedDate = (value, dateString) => {
    setDtmDateCreated(dateString);
  };
  const onChangeSuggestedDate = (value, dateString) => {
                    ...
                    <Form>
                      <Fieldset>
                        ...
                        <DatePicker
                          ...
                          value={
                            dtmDateCreated != null
                              ? moment(dtmDateCreated, "YYYY-MM-DD HH:mm:ss")
                              : ""
                          }
                    ...
                    <Form>
                      <Fieldset>
                        ...
                        <DatePicker
                          ...
                          onChange={onChangeSuggestedDate}
                          style={{ width: "70%" }}
                        />
                      </Fieldset>
                    </Form>
